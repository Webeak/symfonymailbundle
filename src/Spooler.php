...
class Spooler
{
    ...
    {
        try {
            $extras = ArrayUtils::ensureArray($message->getExtras());
            $builderErrors = ArrayUtils::getValue($extras, 'builderErrors', []);
            if (count($builderErrors) > 0) {
                unset($extras['builderErrors']);
